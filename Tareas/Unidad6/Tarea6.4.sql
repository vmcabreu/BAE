...
delimiter // create procedure pa_empleados_sueldo() begin select nombres, apellido, sueldo from empleados; end // 
-- Depues de ejecutar lo de arriba
delimiter ;
...
delimiter // create procedure pa_empleados_hijos() begin select nombres, apellido, cantidadhijos from empleados where cantidadhijos > 0; end // 
-- Depues de ejecutar lo de arriba
delimiter ;
...
UPDATE empleados SET cantidadhijos=0 WHERE nombre='Marta' AND apellido='Perez';
